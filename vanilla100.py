...
def get_args():
    ...
    parser.add_argument('--ckpt', type=str, default='vanillaCIFAR100.pth')
    ...
    parser.add_argument('--num_model', type=int, default=120)
    parser.add_argument('--wandb', '-w', action='store_true')
    parser.add_argument('--ule', action='store_true')
    args = parser.parse_args()

    if args.ule: args.ckpt = 'uleCIFAR10.pth'
...
def get_dataloader(args):
    trainloader, validloader, testloader = cifar100(args.uledir if args.uledir != '' else 1, 
